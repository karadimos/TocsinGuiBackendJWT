...
export class ClusterComponent implements OnInit {
  ...
  openModal(template: TemplateRef<any>, editCluster: ClusterModel) {
    ...
    this.editClusterForm = this.formBuilder.group({
      cluster: this.editCluster.cluster,
      active: this.editCluster.active,
      city: this.editCluster.cityUuid,
      medium: this.editCluster.mediaUuid,
      sender: this.editCluster.senderGroupId
    })
    */
